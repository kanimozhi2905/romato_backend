...
# Database (Using SQLite for compatibility)
DATABASES = {
    'default': {
...
# MONGODB_URI = config('MONGODB_URI', default='mongodb+srv://240171601022_db_user:kani@fooddeliveryai.ghmgxkq.mongodb.net/?appName=Fooddeliveryai')
